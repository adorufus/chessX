...
public class FenUtilities {
    ...
    public static String createFENFromGame(final Board board) {
        return calcualteBoardText(board) + " " + calculateCurrentPlayerText(board) + " " + calculateCastleText(board) + " " + calculateEnPassantSquare(board) + " " + "0 1";
    }
    ...
    private static Alliance moveMaker(String moveMakerString) {
    ...
    private static String calculateEnPassantSquare(Board board) {
        ...
        if(enPassantPawn != null) {
            return BoardUtils.INSTANCE.getPositionAtCoordinate(enPassantPawn.getPiecePosition() + (8) * enPassantPawn.getPieceAlliance().getOppositeDirection());
        }
    ...
    private static String calcualteBoardText(Board board) {
        final StringBuilder builder = new StringBuilder();
