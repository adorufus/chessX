...
public class Pawn extends Piece {
    ...
    public Collection<Move> calculateLegalMoves(final Board board) {
        ...
        for (final int currentCandidateOffset : CANDIDATE_MOVE_PIECE) {
            ...
            } else if (currentCandidateOffset == 16 && this.isFirstMove() && (BoardUtils.SEVENTH_RANK[this.piecePosition] && this.pieceAlliance.isBlack()) || (BoardUtils.SECOND_RANK[this.piecePosition] && this.pieceAlliance.isWhite())) {
    ...
    public Piece movePiece(Move move) {
        return new Pawn(move.getDestinationCoord(), move.getMovedPiece().pieceAlliance);
    }
